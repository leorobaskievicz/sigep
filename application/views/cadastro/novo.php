	...
	*/
	...
	echo ('<div class="row">');
		...
		echo ('<div class="col-xs-6 col-sm-6">');		
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">Confirmação de Senha</label>');
					echo ('<div class="col-xs-7 col-sm-7">
	...
	*/
	...
	echo ('<div class="row">');
		...
		echo ('<div class="col-xs-6 col-sm-6">');		
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">CEP</label>');
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">Rua</label>');
					echo ('<div class="col-xs-10 col-sm-10">
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">Número</label>');
					echo ('<div class="col-xs-5 col-sm-5">
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">Bairro</label>');
					echo ('<div class="col-xs-10 col-sm-10">
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">Cidade</label>');
					echo ('<div class="col-xs-4 col-sm-4">
						<input id="textinput" name="cidade" type="text" placeholder="Cidade" class="form-control input-md">
					</div>');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">UF</label>');
					echo ('<div class="col-xs-4 col-sm-4">
				...
				echo ('<div class="form-group">');
					echo ('<label class="col-xs-2 col-sm-2 control-label" for="textinput">Complemento</label>');
					echo ('<div class="col-xs-10 col-sm-10">
